...
public class ProyectoMDS2RuizSalas20232024PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "ProyectoMDS2RuizSalas20232024";
	...
	private ProyectoMDS2RuizSalas20232024PersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(ocl_proyecto.Usuario.class);
		aMetadataSources.addAnnotatedClass(ocl_proyecto.Editor.class);
		aMetadataSources.addAnnotatedClass(ocl_proyecto.Usuario_suscrito_.class);
		aMetadataSources.addAnnotatedClass(ocl_proyecto.Valoracion.class);
		aMetadataSources.addAnnotatedClass(ocl_proyecto.Comentario.class);
		aMetadataSources.addAnnotatedClass(ocl_proyecto.Periodista.class);
		aMetadataSources.addAnnotatedClass(ocl_proyecto.Noticia.class);
		aMetadataSources.addAnnotatedClass(ocl_proyecto.Seccion.class);
		aMetadataSources.addAnnotatedClass(ocl_proyecto.Tematica.class);
	}
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ProyectoMDS2RuizSalas20232024PersistentManager();
		}

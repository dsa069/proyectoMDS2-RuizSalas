...
public class Lista_mis_noticias_item extends Listar_noticias_generico_item {
	...
	public void eliminar_noticia_propia() {
		...
		this._lista_mis_noticias._unnamed_Historial_noticias_._contiene = new Lista_mis_noticias(this._lista_mis_noticias._unnamed_Historial_noticias_._unnamed_Periodista_, this._lista_mis_noticias._unnamed_Historial_noticias_, this._lista_mis_noticias._unnamed_Historial_noticias_.periodista);

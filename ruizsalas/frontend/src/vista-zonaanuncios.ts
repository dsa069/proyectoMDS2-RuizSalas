...
export class VistaZonaanuncios extends LitElement {
	...
	render() {
		return html`
<vaadin-horizontal-layout style="flex-shrink: 0; height: 100%; width: 100%; justify-content: center;">
 <vaadin-vertical-layout style="flex-shrink: 0; height: 100%; width: 50%; margin: var(--lumo-space-m);">
  <vaadin-button theme="icon" aria-label="Add new" style="flex-shrink: 0; flex-grow: 0; overflow: hidden; background-color: var(--lumo-contrast-0pct); align-self: center; width: 75%; height: 10%;">
  ...
  <vaadin-button theme="icon" aria-label="Add new" style="flex-shrink: 0; flex-grow: 0; height: 10%; overflow: hidden; background-color: var(--lumo-contrast-0pct); align-self: center; width: 75%;">
  ...
  <hr style="flex-shrink: 0; width: 90%;">
  <vaadin-button style="flex-shrink: 0; flex-grow: 0; height: 10%; overflow: hidden; background-color: var(--lumo-contrast-0pct); align-self: center; width: 75%;">

...
<vaadin-horizontal-layout class="content" style="width: 100%; height: 100%; justify-content: center;">
 <vaadin-vertical-layout style="flex-shrink: 0; justify-content: center; flex-grow: 1; height: 100%; width: 100%;" id="editarPerfil">
  <vaadin-button theme="icon" aria-label="Add new" style="flex-shrink: 0; overflow: hidden; background-color: var(--lumo-contrast-0pct); border-radius: 50%; align-self: center; height: 100%;">
   <vaadin-vertical-layout id="layoutImagenPerfilIntroducirDatos">
 ...
 <vaadin-vertical-layout style="flex-shrink: 0; flex-grow: 1; height: 100%; justify-content: center; width: 100%;">
  ...
  <vaadin-vertical-layout id="zonaRegistrarPeriodista" style="flex-shrink: 0; width: 100%; flex-grow: 0;">
   ...
   <vaadin-vertical-layout theme="spacing" id="FotoTextamen" style="align-self: stretch;">
    <vaadin-text-field label="Foto" placeholder="Foto" style="width: 100%; flex-shrink: 0; margin: var(--lumo-space-m);" id="campoFoto"></vaadin-text-field>
   </vaadin-vertical-layout>
  </vaadin-vertical-layout>
  <vaadin-vertical-layout id="datosRegistro" style="width: 100%; flex-shrink: 0;">
   <vaadin-text-field label="Tarjeta de crédito" placeholder="Tarjeta de crédito" style="width: 100%; flex-shrink: 0; margin: var(--lumo-space-m);" id="tarjetaDeCrédito" dir="campoDineros"></vaadin-text-field>
  </vaadin-vertical-layout>
 </vaadin-vertical-layout>

...
<vaadin-vertical-layout style="width: 100%; height: 100%;">
 <vaadin-horizontal-layout style="width: 100%; height: 40%; flex-shrink: 0; align-items: center; justify-content: flex-start;">
  ...
  <vaadin-vertical-layout style="width: 15%; height: 60%; flex-shrink: 0;"></vaadin-vertical-layout>
  <vaadin-vertical-layout style="flex-shrink: 0; width: 15%; height: 60%;"></vaadin-vertical-layout>
  <vaadin-vertical-layout style="flex-shrink: 0; width: 15%; height: 60%;"></vaadin-vertical-layout>
 ...
 <vaadin-horizontal-layout style="width: 100%; height: 10%; flex-shrink: 0; font-size: 50px; align-items: center; justify-content: space-between;">
  ...
  <vaadin-horizontal-layout style="height: 60%; width: 10%;">
  ...
  <vaadin-button theme="icon" aria-label="Add new" style="flex-grow: 0; flex-shrink: 0; height: 60%; width: 5%; background-color: var(--lumo-contrast-0pct); overflow: hidden;">
 ...
 <vaadin-horizontal-layout style="width: 100%; height: 40%; flex-shrink: 0; font-size: 20px;">
  <vaadin-vertical-layout style="width: 50%; flex-shrink: 0; height: 100%;">
 ...
 <vaadin-vertical-layout style="width: 100%; height: 10%; flex-shrink: 0; justify-content: center;">

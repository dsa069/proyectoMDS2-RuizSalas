...
<vaadin-vertical-layout theme="spacing" style="width: 100%; height: 100%; justify-content: space-between;" id="layoutSeleccionSeccionesGenerico">
 <vaadin-horizontal-layout class="content" style="width: 100%; height: 8%; position: absolute; flex-shrink: 0;">
  ...
  <vaadin-horizontal-layout theme="spacing" style="flex-shrink: 0; flex-grow: 1; padding: var(--lumo-space-m);" id="layoutSeccionesContenidasPeriodico"></vaadin-horizontal-layout>
 ...
 <vaadin-horizontal-layout id="layoutGenericoSeccionesBanner" style="flex-shrink: 0; width: 100%;"></vaadin-horizontal-layout>
